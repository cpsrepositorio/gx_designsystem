...
## Layout control
O [Abstract Editor](https://docs.genexus.com/en/wiki?25250,How+to+use+the+Abstract+Editor%3A+designing+a+Web+Transaction+Form){:target="_blank"} do Genexus possibilita criar alguns tipos de layouts para controlar os objetos na interface:
